...
open class CustomLayoutManager : LayoutManager, RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     */
    public var smoothScrollDirectionDecider: (Int, CustomLayoutManager, Int) -> Int = ::defaultDecider
    ...
    public fun findViewByPosition(
        adapterIndex: Int,
        strategy: (targetIndex: Int, layoutManager: CustomLayoutManager) -> View?
    ): View? {
    ...
    private inner class LoopingSmoothScroller(
        ...
        public override fun onStart() {
            ...
            val time = 500  // MS.
            (layoutManager as CustomLayoutManager).extraLayoutSpace = (rate * time).toInt()
        }
        ...
        public override fun onStop() {
            (layoutManager as CustomLayoutManager).extraLayoutSpace = 0
        }
    ...
    private class LayoutRequest() : Parcelable {
         ...
         */
        private var scrollStrategy: ((Int, CustomLayoutManager, Int) -> Int)? = null
        ...
        public constructor(
            ...
            scrollStrategy: ((Int, CustomLayoutManager, Int) -> Int)? = null,
            layoutManager: CustomLayoutManager? = null,
         ...
         */
        public fun initialize(layoutManager: CustomLayoutManager, state: RecyclerView.State) {
